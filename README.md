# nvim-treesitter-queries-ledger

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-ledger/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-ledger/actions/workflows/validate.yml)

Neovim tree-sitter queries for **ledger**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-ledger",
...
- [ ] Changes are scoped to `ledger` — do not include files for other languages
